...
class Tetris:
    def __init__(self):
        ...
        self.sound = self._sound_new_round()
    ...
    def _sound_new_round(self):
        return playsound('theme_music.mp3', block = False)
    ...
    def draw_manual(self):
        self.move_cursor(36, 0)
        # 绘制操作说明
        print("Controls:")
        print("A=left, D=right, S=down, W=rotate; or arrow keys")
        print("Space: Hard drop")
        print("C: Hold/exchange pieces")
